...
/*
  public static void main(String[] args) {
    ...
    // Línea 18: Paso constructor con sus respectivos parámetros.
    // Seteo la cuenta y paso los parámetros.
    ...
    System.out.println("Customer [" + customer.getLastName()
		       ...
		       + "] has a balance of " + account.getBalance());
    System.out.println();
    System.out.println("La cantidad de clientes del banco es: " + bank.getNumOfCustomers());
  }
    */
}
